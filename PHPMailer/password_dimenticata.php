<?php
if ((isset($_GET["error"]) && $_GET["error"] == "email_non_presente")){
        echo '<script language="javascript">alert("Email non presente nel database, prova a reinserirla")</script>';
    }
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form action="./crea_token.php" method="POST">
                                <div class="input-group mb-3">
                                    <span class="input-group-text">@</span>
                                    <div class="form-floating">
                                        <input type="email" name="email_utente" class="form-control" id="email_utente" placeholder="email">
                                        <label for="email_utente">Inserisci qui la tua email</label>
                                    </div>
                                </div>
                                <button type="submit" name="reset_request" class="btn btn-success btn-block ">Ricevi token</button>
                            </form>
                        </div>
                    </div>
                </div>
