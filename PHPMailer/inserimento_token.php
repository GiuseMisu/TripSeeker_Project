...
<script>
    //controlla url e se è inserimento_token.php?email=$email&errore=token_errato allora mostra il messaggio di errore
    if (window.location.href.indexOf("error=token_errato") > -1) {
        alert("Il token inserito non è corretto, riprova");
        window.location.href = "inserimento_token.php?email=<?php echo $_GET['email'] ?>";
    }
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p>Inserisci il token che ti è stato inviato via mail</p>
                            <form action="cambio_password.php" method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <label for="token">Inserisci il token</label>
                                    </div>
                                </div>
                                <br>
                                <button type="submit" name="pulsante_invio_token" class="btn btn-success btn-block">Invia</button>
                            </form>         
                        </div>
