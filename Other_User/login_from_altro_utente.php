    ...
    <?php
        if ($dbconn) {
            ...
            if (!($tuple=pg_fetch_array($result, null, PGSQL_ASSOC))) {
                header("Location: ../signUp/index.html?error=email-nuova-errore");
                exit();
            }
                ...
                if (!($tuple=pg_fetch_array($result, null, PGSQL_ASSOC))) {
                    ...
                    header("Location: Altro_Utente.php?error=password-sbagliata");exit();//avendoci questo url in index.html cè funzione che controlla url e in caso manda alert
                }
                else {
                    session_start();
                    ...
                    header("Location: Altro_Utente.php?email=".$_POST['email_utente_profilo']."");
                }
            }
        }
        else {
